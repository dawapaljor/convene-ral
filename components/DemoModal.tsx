      ...
      >
        ...
        {status === 'success' ? (
          <div className="p-8 text-center flex flex-col items-center justify-center min-h-[350px]">
            <div className="w-16 h-16 bg-brand-50 rounded-full flex items-center justify-center mb-6 text-brand-500 animate-bounce">
            ...
            <p className="text-slate-500 mb-8 text-sm max-w-xs mx-auto">
              Experience the power of Convene in action. Our team will get back to you shortly.
            </p>
            <button
              onClick={onClose}
          ...
          <div className="p-8">
            ...
            <form className="space-y-4" onSubmit={handleSubmit} data-netlify="true" name="demo-request">
